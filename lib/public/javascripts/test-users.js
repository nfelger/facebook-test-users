$(function() {
  ...
  window.TestUsers = Backbone.Collection.extend({
    ...
    url: function() {
      return "https://graph.facebook.com/" + this.accessToken.get('appId') + "/accounts/test-users?callback=?&access_token=" + this.accessToken.get('accessToken');
    },
  ...
  window.TestUsersView = Backbone.View.extend({
    ...
    el: function() {
      return $("#testUsers" + this.accessToken.get('appId') + " tbody");
    },
    ...
    fetchUsers: function() {      
      ...
      this.testUsers.accessToken = this.accessToken;
  ...
  window.ApplicationView = Backbone.View.extend({
    ...
    fetchUsers: function() {
      ...
      testUsersView.accessToken = accessToken;
      testUsersView.applicationView = this;
      accessToken.fetch();
      accessToken.bind('change', testUsersView.fetchUsers);
